...
var TEMPLATES = {
        ROOT: '' +
            '<form class="mform atto_form atto_media atto_subtitle_form" id="{{elementid}}_atto_subtitle_form">' +
...
Y.namespace('M.atto_subtitle').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _loadRecorders: function(){
        var that = this;
        that.uploaded=false;
        require(['atto_subtitle/subtitleloader'], function(loader) {
